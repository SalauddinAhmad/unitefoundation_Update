        ...
        <div className="container-page py-14 grid grid-cols-2 md:grid-cols-4 gap-10">
          <div className="col-span-2 md:col-span-1">
            ...
            <div className="flex flex-wrap gap-2 mt-5">
              <a href={site.socials.facebook} target="_blank" rel="noopener noreferrer" aria-label="Facebook" className="p-2 rounded-btn bg-white/5 hover:bg-white/10 transition-colors"><Facebook className="h-4 w-4" /></a>
              <a href={site.socials.youtube} target="_blank" rel="noopener noreferrer" aria-label="YouTube" className="p-2 rounded-btn bg-white/5 hover:bg-white/10 transition-colors"><Youtube className="h-4 w-4" /></a>
              <a href={site.socials.tvFacebook} target="_blank" rel="noopener noreferrer" aria-label="Unite TV Facebook" className="p-2 rounded-btn bg-white/5 hover:bg-white/10 transition-colors"><Tv className="h-4 w-4" /></a>
              <a href={site.socials.tvYoutube} target="_blank" rel="noopener noreferrer" aria-label="Unite TV YouTube" className="p-2 rounded-btn bg-white/5 hover:bg-white/10 transition-colors"><Youtube className="h-4 w-4" /></a>
            </div>
          </div>
