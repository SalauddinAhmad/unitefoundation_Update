...
const Settings = () => {
  ...
  const save = async () => {
    ...
    // Keep a local safety copy so a bad/partial save on the server can always
    // be recovered from this browser (or exported as JSON).
    try { localStorage.setItem("uf_settings_backup", JSON.stringify(form)); } catch { /* quota */ }
