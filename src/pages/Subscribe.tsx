...
const Subscribe = () => {
  ...
  return (
    <div className="min-h-screen w-full flex items-center justify-center bg-muted/30 p-4 sm:p-8 relative overflow-hidden">
      <Seo
      ...
      >
        <ArrowLeft className="h-4 w-4" /> হোমপেজ
      </Link>
      ...
      <div className="relative max-w-xl w-full bg-card rounded-[2.5rem] shadow-2xl shadow-primary/5 border border-border p-8 sm:p-12 overflow-hidden group">
        ...
        {state !== "done" ? (
          <div className="relative flex flex-col items-center text-center space-y-6">
            {/* Brand mark */}
            <img src={logo} alt="Unite Foundation" className="h-10 w-auto mb-1" />
