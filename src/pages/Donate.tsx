        ...
        <div className="container mx-auto px-4">
          <figure className="relative mx-auto max-w-2xl">
            <div className="relative flex items-stretch gap-3 sm:gap-4 rounded-2xl border border-primary/20 bg-card/80 backdrop-blur-sm px-4 py-3.5 sm:px-6 sm:py-4 shadow-sm">
              ...
              {/* Decorative star (mobile-friendly) */}
              ...
              <div className="flex-1 min-w-0">
                <div className="flex items-center gap-2 mb-1.5">
                  <span className="text-[10px] sm:text-[11px] font-semibold tracking-[0.2em] uppercase text-primary/80">
                    হাদীসে নববী ﷺ
                  </span>
                </div>
                <blockquote className="text-[15px] sm:text-base md:text-lg leading-[1.75] text-foreground font-medium">
