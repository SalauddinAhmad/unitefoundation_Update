...
const volunteer: FormSchema = {
  ...
  fields: [
    ...
    { key: "city", label: "শহর / জেলা", type: "select", required: true, options: ["ঢাকা", "চট্টগ্রাম", "রাজশাহী", "খুলনা", "বরিশাল", "সিলেট", "রংপুর", "ময়মনসিংহ", "কুমিল্লা", "গাজীপুর", "নারায়ণগঞ্জ"] },
...
const representative: FormSchema = {
  ...
  fields: [
    ...
    { key: "district", label: "জেলা", type: "select", required: true, options: ["ঢাকা", "চট্টগ্রাম", "রাজশাহী", "খুলনা", "বরিশাল", "সিলেট", "রংপুর", "ময়মনসিংহ", "কুমিল্লা", "গাজীপুর", "নারায়ণগঞ্জ"] },
